...
const ProductTiles = (props) => {
    ...
    return (<>
        <div className="action-button">
            ...
            <div className="sort-products" onClick={() => sortCallParent()}>
            ...
            <select className="sort-dropdown" onChange={(ev) => { props.sortProduct(ev.target.value,1) }}>
                ...
                <option value={JSON.stringify({ key: "rating", val: "rating-high-low" })}>Sort by Rating High-Low</option>
                <option value={JSON.stringify({ key: "rating", val: "rating-low-high" })}>Sort by Rating Low-High</option>
